  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      <input
        ref={ref}
        className={cn(
          "immersive-input-sunken flex h-11 w-full rounded-xl px-4 py-2 text-sm text-white placeholder:text-slate-500",
          "border border-white/5 bg-slate-950/60",
          "shadow-[inset_0_4px_12px_rgba(0,0,0,0.45),inset_0_1px_0_rgba(255,255,255,0.04)]",
          "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-400/50",
          "focus-visible:shadow-[inset_0_4px_12px_rgba(0,0,0,0.5),0_0_0_1px_rgba(45,212,191,0.4),0_0_20px_rgba(45,212,191,0.15)]",
