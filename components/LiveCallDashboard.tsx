      ...
      <div className="flex flex-col border-r border-white/5">
        <header className="flex items-center justify-between border-b border-white/5 bg-black/20 px-6 py-4 backdrop-blur-md">
          <div className="flex items-center gap-4">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl border border-teal-500/30 bg-teal-600/20">
              <IconVideoSession className="h-5 w-5 text-teal-400" />
            </div>
            <div>
          ...
          <div className="flex items-center gap-4">
            ...
            <Badge variant="outline" className="border-teal-500/50 bg-teal-500/10 capitalize text-teal-300">
                  ...
                  >
                    ...
                    <div className={`max-w-[80%] rounded-2xl px-4 py-3 text-sm leading-relaxed ${
                      s.speaker?.toLowerCase().includes('alex') || s.speaker?.toLowerCase().includes('sam') || s.speaker?.toLowerCase().includes('jordan') || s.speaker?.toLowerCase().includes('casey')
                        ? 'border border-teal-500/30 bg-teal-600/20 text-white'
          ...
          <div className="border-t border-white/5 bg-black/40 p-6 backdrop-blur-xl overflow-hidden grid grid-cols-2 gap-6">
            ...
            <div className="space-y-4 overflow-hidden flex flex-col">
              <h3 className="flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-emerald-400">
                <IconConversionBars className="h-4 w-4" />
                Buying Signals
              </h3>
              <ScrollArea className="flex-1 pr-4">
                <div className="space-y-3">
        ...
        <div className="p-6 space-y-8 flex-1 overflow-y-auto">
          <section className="space-y-4">
            <div className="flex items-center justify-between">
              <h3 className="text-xs font-bold uppercase tracking-widest text-teal-400">Current strategy</h3>
              <Badge variant="secondary" className="border-none bg-teal-500/10 text-[10px] text-teal-300">
          ...
          <section className="space-y-4">
            <h3 className="text-xs font-bold uppercase tracking-widest text-teal-400">Deal memory</h3>
            <div className="space-y-3">
              {memories.map((m, i) => (
                <div key={i} className="bg-white/5 p-3 rounded-lg border border-white/5 space-y-1">
                  <div className="flex items-center justify-between">
                    <Badge variant="outline" className="border-teal-500/30 text-[8px] uppercase tracking-widest text-teal-300">
                      {m.category}
                    </Badge>
          ...
          <section className="space-y-4">
            <h3 className="text-xs font-bold uppercase tracking-widest text-teal-400">Qualification notes</h3>
            <div className="space-y-3">
