...
export const PERSONAS: Record<string, Persona> = {
  ...
  praneeth_assist: {
    ...
    systemPrompt: (companyContext: any) => `
      ...
      - GTM Plan: ${companyContext.analysis?.gtmPlan || 'N/A'}
      - Strategic Outreach: ${companyContext.analysis?.strategicOutreachApproach || companyContext.challenges?.join(', ')}
      - Differentiation: ${(companyContext.analysis?.marketDifferentiationTriggers || []).join('; ') || 'N/A'}
