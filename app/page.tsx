        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-8 space-y-8 text-left">
            ...
            <p className="max-w-xl text-[#9f9f93] text-base sm:text-lg leading-relaxed font-light">
              DealFlow AI deploys collaborative agents with persistent memory directly integrated with your CRM. Reclaim 60% of your sales rep&rsquo;s calendar by automating updates, call dialers, and outreach sequences.
            </p>
