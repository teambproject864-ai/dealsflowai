...
function FeaturesContent() {
  ...
  if (error) {
    return (
      <div className="mx-auto max-w-lg py-20 text-center">
        ...
        <h2 className="text-2xl font-bold text-white">Unable to load features</h2>
        <p className="mt-2 text-slate-400">{error}</p>
        <Button onClick={() => window.location.reload()} variant="outline" className="mt-6 border-white/10 hover:bg-white/5">
          Try again
        </Button>
      </div>
    );
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="absolute top-[10%] left-[-10%] w-[35rem] h-[35rem] rounded-full bg-violet-600/10 blur-[120px] pointer-events-none" />
      <div className="absolute top-[40%] right-[-10%] w-[35rem] h-[35rem] rounded-full bg-teal-600/10 blur-[120px] pointer-events-none" />
      ...
      <section className="relative pt-24 pb-16 md:pt-32 md:pb-24 border-b border-white/5">
        <div className="max-w-5xl mx-auto text-center px-6 space-y-6">
          <motion.div 
            ...
            className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-teal-500/30 bg-teal-500/10 text-teal-300 text-xs font-semibold uppercase tracking-wider mb-2"
          >
          ...
          <motion.h1
            ...
            className="text-4xl sm:text-6xl font-bold tracking-tight text-white max-w-4xl mx-auto leading-tight"
          >
      ...
      <section className="py-20 sm:py-28 max-w-7xl mx-auto px-6 border-b border-white/5">
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          <h2 className="text-3xl sm:text-5xl font-bold text-white">The Core Systems</h2>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {CORE_ARCHITECTURE.map((core, idx) => (
            <motion.div
              ...
              className={`group relative p-8 rounded-3xl border ${core.borderColor} bg-gradient-to-b ${core.bgGradient} to-transparent backdrop-blur-md transition-all duration-500 overflow-hidden flex flex-col justify-between`}
            >
              ...
              <div>
                <div className="flex items-center justify-between mb-6">
                  <div className={`p-4 rounded-2xl bg-white/5 ${core.accent} border border-white/10 transition-transform duration-300 group-hover:scale-110`}>
                    <core.icon className="h-8 w-8" />
                  </div>
                  <Badge className="bg-white/5 hover:bg-white/10 text-slate-300 border-white/10">v2.4 Stable</Badge>
                </div>

                <h3 className="text-2xl sm:text-3xl font-bold text-white mb-3 tracking-tight">{core.title}</h3>
                <p className="text-slate-300 font-medium mb-6">{core.definition}</p>
              ...
              <div className="mt-8 pt-6 border-t border-white/5 space-y-4">
                <div>
                  <h4 className="text-xs font-semibold uppercase tracking-wider text-slate-500 mb-1">Integration & Synergy</h4>
                  <p className="text-slate-400 text-xs leading-relaxed">{core.synergy}</p>
                </div>
                <div>
                  <h4 className="text-xs font-semibold uppercase tracking-wider text-slate-500 mb-1">Tangible Business Impact</h4>
                  <p className="text-emerald-400 text-xs font-medium leading-relaxed">{core.benefit}</p>
                </div>
              </div>
            </motion.div>
          ))}
      ...
      <section className="py-20 sm:py-28 max-w-7xl mx-auto px-6 border-b border-white/5">
        <div className="flex flex-col gap-8 md:flex-row md:items-end md:justify-between border-b border-white/5 pb-12 mb-12">
          <div className="space-y-2">
            <h2 className="text-3xl sm:text-4xl font-bold text-white">Capabilities Directory</h2>
            <p className="text-slate-400">Filter and explore the complete standard suite of DealFlow.AI modules.</p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 items-stretch sm:items-center">
            <div className="relative min-w-[280px]">
              ...
              <Input 
                ...
                className="pl-11 w-full bg-white/3 border-white/8 text-white placeholder:text-slate-500 focus-visible:ring-teal-500/50 rounded-xl"
                value={searchQuery}
          ...
          <AnimatePresence mode="popLayout">
            {filteredFeatures.map((f, i) => {
              ...
              return (
                ...
                >
                  <Card className="h-full bg-white/3 border-white/8 hover:bg-white/5 hover:border-white/15 transition-all duration-300 group overflow-hidden flex flex-col justify-between">
                    <CardHeader className="space-y-4">
                      <div className="flex justify-between items-start">
                        ...
                        {f.isNew && (
                          <Badge className="bg-emerald-500/10 text-emerald-400 border border-emerald-500/30 font-semibold text-[10px] tracking-wider uppercase px-2 py-0.5">New</Badge>
                        )}
                      </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            ...
            <motion.div
              ...
              className={`p-8 rounded-3xl bg-white/3 border ${item.borderColor} hover:bg-white/5 hover:border-white/15 transition-all duration-300`}
            >
              <div className={`p-3 rounded-2xl w-fit mb-6 ${item.bg} ${item.color} border border-white/5`}>
      ...
      <section className="py-24 max-w-7xl mx-auto px-6 text-center">
        <div className="relative p-12 md:p-20 rounded-[2.5rem] border border-teal-500/20 bg-gradient-to-b from-teal-500/10 via-[#060612]/80 to-[#060612] overflow-hidden">
          ...
          <div className="relative max-w-3xl mx-auto space-y-8">
            <h2 className="text-3xl sm:text-5xl font-bold text-white">Why leading teams choose DealFlow.ai</h2>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 pt-4">
              {[
                ...
                <div key={stat.label} className="p-4 rounded-2xl bg-white/3 border border-white/5">
                  <div className="text-3xl md:text-4xl font-extrabold text-teal-400 mb-1">{stat.value}</div>
                  <div className="text-xs font-bold text-white uppercase tracking-wider mb-0.5">{stat.label}</div>
            ...
            <div className="pt-8 flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link href="/book-demo" className="w-full sm:w-auto">
                <Button
                  size="lg"
                  className="w-full h-14 rounded-xl bg-teal-500 hover:bg-teal-400 text-white font-semibold shadow-lg shadow-teal-500/25 transition-all hover:-translate-y-0.5"
                >
              ...
              <Link href="/book-demo?trial=true" className="w-full sm:w-auto">
                <Button
                  size="lg"
                  variant="outline"
                  className="w-full h-14 rounded-xl border-white/10 bg-white/3 text-white hover:bg-white/5 transition-all"
                >
                  Start Free Trial
                </Button>
              </Link>
...
export default function FeaturesPage() {
  return (
    <div className="min-h-screen bg-dealflow-ink">
      <Suspense fallback={
