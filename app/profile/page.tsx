  ...
  return (
    <main className="min-h-screen bg-dealflow-blue text-white relative py-12 px-4 z-10 flex flex-col justify-center">
      <div className="mx-auto max-w-2xl w-full">
        ...
        >
          <GlassPanel material="glass" className="border border-white/10 shadow-2xl overflow-hidden rounded-3xl p-0" tilt={false}>
            {/* Glassmorphic header details */}
            <div className="bg-gradient-to-r from-teal-500/10 via-violet-500/5 to-transparent border-b border-white/5 px-8 py-6 flex items-center gap-6">
              <div className="h-16 w-16 rounded-full bg-gradient-to-tr from-teal-400 to-violet-500 p-0.5 flex items-center justify-center shadow-lg shadow-teal-500/10">
                <div className="h-full w-full rounded-full bg-slate-950 flex items-center justify-center text-teal-400 text-2xl font-black">
                  {profile.name.split(" ").map(w => w[0]).join("")}
                </div>
              </div>
              <div>
                <h2 className="text-xl font-bold text-white tracking-tight sm:text-2xl font-display">{profile.name}</h2>
                <p className="text-xs text-teal-300 font-semibold uppercase tracking-wider mt-1">{profile.title} @ {profile.company}</p>
              </div>
            </div>
              ...
              <AnimatePresence>
                {saved && (
                  <motion.div
                    ...
                    className="mb-6 p-4 rounded-xl border border-emerald-500/20 bg-emerald-500/10 text-emerald-300 flex items-center gap-3"
                  >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      <option value="Marketing">Growth Specialist / Marketing</option>
